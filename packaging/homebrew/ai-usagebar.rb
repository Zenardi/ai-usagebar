...
# live copy lives in the tap repo `akitaonrails/homebrew-tap` so users can run
...
class AiUsagebar < Formula
  ...
  on_arm do
    url "https://github.com/akitaonrails/ai-usagebar/releases/download/v#{version}/ai-usagebar-darwin-arm64.tar.gz"
    # Replace with the real digest from ai-usagebar-darwin-arm64.tar.gz.sha256
    sha256 "REPLACE_WITH_DARWIN_ARM64_SHA256"
  end

  on_intel do
    url "https://github.com/akitaonrails/ai-usagebar/releases/download/v#{version}/ai-usagebar-darwin-x86_64.tar.gz"
